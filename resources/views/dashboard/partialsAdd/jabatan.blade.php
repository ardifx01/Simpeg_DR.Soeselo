    ...
    @endisset
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-8 col-lg-9">
                <input name="skpd" type="text" class="form-control @error('skpd') is-invalid @enderror" id="skpd" value="{{ $jabatan->skpd ?? 'RSUD dr. Soeselo Slawi' }}" disabled>
                @error('skpd')
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4 col-lg-3">
                <select class="form-select" aria-label="Default select example" name="formasi_jabatan" id="formasi_jabatan" required>
                    <option selected disabled>-- Pilihan --</option>
                    @php
            ...
            <div class="col-md-4 col-lg-3">
                <select class="form-select" aria-label="Default select example" name="formasi_jabatan_tingkat" id="formasi_jabatan_tingkat" required>
                    <option selected disabled>-- Pilihan --</option>
                    @php
            ...
            <div class="col-md-4 col-lg-3">
                <select class="form-select" aria-label="Default select example" name="formasi_jabatan_Keterangan" id="formasi_jabatan_Keterangan" required>
                    <option selected disabled>-- Pilihan --</option>
                    @php
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4 col-lg-3">
                <select class="form-select" aria-label="Default select example" name="pangkat" id="pangkat" required>
                    <option selected disabled>-- Pilihan --</option>
                    @php
                        $pangkatOptions = [
            ...
            <div class="col-md-4 col-lg-3">
                <select class="form-select" aria-label="Default select example" name="golongan_ruang" id="golongan_ruang" required>
                    <option selected disabled>-- Pilihan --</option>
                    @php
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4 col-lg-3">
                <input name="tmt_golongan_ruang" type="text" class="form-control @error('tmt_golongan_ruang') is-invalid @enderror" id="tmt_golongan_ruang" value="{{ old('tmt_golongan_ruang', $jabatan->tmt_golongan_ruang ?? '') }}" required>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4 col-lg-3">
                <select class="form-select" aria-label="Default select example" name="golongan_ruang_cpns" id="golongan_ruang_cpns" required>
                    <option selected disabled>-- Pilihan --</option>
                    @php
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4 col-lg-3">
                <input name="tmt_golongan_ruang_cpns" type="text" class="form-control @error('tmt_golongan_ruang_cpns') is-invalid @enderror" id="tmt_golongan_ruang_cpns" value="{{ old('tmt_golongan_ruang_cpns', $jabatan->tmt_golongan_ruang_cpns ?? '') }}" required>
            ...
            <div class="col-md-4 col-lg-3">
                <input name="tmt_pns" type="text" class="form-control @error('tmt_pns') is-invalid @enderror" id="tmt_pns" value="{{ old('tmt_pns', $jabatan->tmt_pns ?? '') }}" required>
                @error('tmt_pns')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4 col-lg-3">
                <input name="sk_pengangkatan_blud" type="text" class="form-control @error('sk_pengangkatan_blud') is-invalid @enderror" id="sk_pengangkatan_blud" value="{{ old('sk_pengangkatan_blud', $jabatan->sk_pengangkatan_blud ?? '') }}" required>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4 col-lg-3">
                <input name="mou_awal_blud" type="text" class="form-control @error('mou_awal_blud') is-invalid @enderror" id="mou_awal_blud" value="{{ old('mou_awal_blud', $jabatan->mou_awal_blud ?? '') }}" required>
                @error('mou_awal_blud')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-md-4 col-lg-3">
                <div class="input-group">
                    <input name="tgl_mou_awal_blud" type="text" class="form-control @error('tgl_mou_awal_blud') is-invalid @enderror" id="tgl_mou_awal_blud" aria-label="Recipient's username" aria-describedby="button-addon2" value="{{ old('tgl_mou_awal_blud', $jabatan->tgl_mou_awal_blud ?? '') }}" required>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4 col-lg-3">
                <div class="input-group">
                    <input name="tmt_awal_mou_blud" type="text" class="form-control @error('tmt_awal_mou_blud') is-invalid @enderror" id="tmt_awal_mou_blud" aria-label="Recipient's username" aria-describedby="button-addon2" value="{{ old('tmt_awal_mou_blud', $jabatan->tmt_awal_mou_blud ?? '') }}" required>
            ...
            <div class="col-md-4 col-lg-3">
                <div class="input-group">
                    <input name="tmt_akhir_mou_blud" type="text" class="form-control @error('tmt_akhir_mou_blud') is-invalid @enderror" id="tmt_akhir_mou_blud" aria-label="Recipient's username" aria-describedby="button-addon2" value="{{ old('tmt_akhir_mou_blud', $jabatan->tmt_akhir_mou_blud ?? '') }}" required>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4 col-lg-3">
                <input name="mou_akhir_blud" type="text" class="form-control @error('mou_akhir_blud') is-invalid @enderror" id="mou_akhir_blud" value="{{ old('mou_akhir_blud', $jabatan->mou_akhir_blud ?? '') }}" required>
            ...
            <div class="col-md-4 col-lg-3">
                <div class="input-group">
                    <input name="tgl_akhir_blud" type="text" class="form-control @error('tgl_akhir_blud') is-invalid @enderror" id="tgl_akhir_blud" aria-label="Recipient's username" aria-describedby="button-addon2" value="{{ old('tgl_akhir_blud', $jabatan->tgl_akhir_blud ?? '') }}" required>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4 col-lg-3">
                <div class="input-group">
                    <input name="tmt_mou_akhir" type="text" class="form-control @error('tmt_mou_akhir') is-invalid @enderror" id="tmt_mou_akhir" aria-label="Recipient's username" aria-describedby="button-addon2" value="{{ old('tmt_mou_akhir', $jabatan->tmt_mou_akhir ?? '') }}" required>
            ...
            <div class="col-md-4 col-lg-3">
                <div class="input-group">
                    <input name="tmt_akhir_mou" type="text" class="form-control @error('tmt_akhir_mou') is-invalid @enderror" id="tmt_akhir_mou" aria-label="Recipient's username" aria-describedby="button-addon2" value="{{ old('tmt_akhir_mou', $jabatan->tmt_akhir_mou ?? '') }}" required>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4 col-lg-3">
                <input name="no_mou_mitra" type="text" class="form-control @error('no_mou_mitra') is-invalid @enderror" id="no_mou_mitra" value="{{ old('no_mou_mitra', $jabatan->no_mou_mitra ?? '') }}" required>
                @error('no_mou_mitra')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-md-4 col-lg-3">
                <div class="input-group">
                    <input name="tgl_mou_mitra" type="text" class="form-control @error('tgl_mou_mitra') is-invalid @enderror" id="tgl_mou_mitra" aria-label="Recipient's username" aria-describedby="button-addon2" value="{{ old('tgl_mou_mitra', $jabatan->tgl_mou_mitra ?? '') }}" required>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4 col-lg-3">
                <div class="input-group">
                    <input name="tmt_mou_mitra" type="text" class="form-control @error('tmt_mou_mitra') is-invalid @enderror" id="tmt_mou_mitra" aria-label="Recipient's username" aria-describedby="button-addon2" value="{{ old('tmt_mou_mitra', $jabatan->tmt_mou_mitra ?? '') }}" required>
            ...
            <div class="col-md-4 col-lg-3">
                <div class="input-group">
                    <input name="tmt_akhir_mou_mitra" type="text" class="form-control @error('tmt_akhir_mou_mitra') is-invalid @enderror" id="tmt_akhir_mou_mitra" aria-label="Recipient's username" aria-describedby="button-addon2" value="{{ old('tmt_akhir_mou_mitra', $jabatan->tmt_akhir_mou_mitra ?? '') }}" required>
