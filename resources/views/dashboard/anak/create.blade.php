...
@section('main')
        ...
        <div class="pagetitle">
            <div class="row justify-content-between">
                <div class="col">
                    <h1>Anak | <small>Tambah Anak</small></h1>
                    <nav>
                        <ol class="breadcrumb">
            ...
            <div class="container rounded shadow p-4">
                <form action="{{ route('anak.store') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <label for="tempat_lahir" class="col-md-4 col-lg-3 col-form-label">3. Tempat, Tanggal Lahir</label>
                            ...
                            <div class="col-md-4 col-lg-3">
                                <div class="input-group">
                                    <input name="tanggal_lahir" type="text" class="form-control @error('tanggal_lahir') is-invalid @enderror" id="tanggal_lahir" aria-label="Recipient's username" aria-describedby="button-addon2" value="{{ old('tanggal_lahir') }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4 col-lg-3">
                                <select class="form-select" aria-label="Default select example" name="status_keluarga" id="status_keluarga">
                                    ...
                                    <option value="Anak Kandung" {{ old('status_keluarga')=='Anak Kandung' ? 'selected': '' }} >1. Anak Kandung</option>
                                    <option value="Anak Angkat" {{ old('status_keluarga')=='Anak Angkat' ? 'selected': '' }} >2. Anak Angkat</option>
                                    <option value="Anak Tiri" {{ old('status_keluarga')=='Anak Tiri' ? 'selected': '' }} >3. Anak Tiri</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4 col-lg-3">
                                <select class="form-select" aria-label="Default select example" name="status_tunjangan" id="status_tunjangan">
                                    <option selected>...</option>
                                    <option value="Dapat" {{ old('status_tunjangan')=='Dapat' ? 'selected': '' }} >1. Dapat</option>
                                    <option value="Tidak Dapat" {{ old('status_tunjangan')=='Tidak Dapat' ? 'selected': '' }} >2. Tidak Dapat</option>
                                </select>
                            </div>
                        </div>
