...
<div class="container-fluid">
    <div class="pagetitle">
        <div class="row justify-content-between">
            <div class="col">
                <h1>Rekapitulasi | <small>Pegawai Bedasarkan Status Jenis Kelamin</small></h1>
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item active">Status Jenis Kelamin</li>
                    </ol>
                </nav>
            </div>
            <div class="col">
    ...
    </div><!-- End Rekapitulasi Status Jenis Kelamin Title -->

    {{-- Notifikasi jika ada pegawai tanpa JenisKelamin --}}
    @if ($pegawaiTanpaJenisKelamin > 0)
        <div class="alert alert-success" role="alert">
            <i class="bi bi-info-circle"></i> 
            <strong>Perhatian.</strong> Terdapat <strong>{{ $pegawaiTanpaJenisKelamin }}</strong> data pegawai tidak dilengkapi dengan Jenis Kelamin. 
            <a href="#" class="alert-link" data-bs-toggle="modal" data-bs-target="#modalPegawaiTanpaJenisKelamin">Lihat detail</a>
        </div>
        <!-- Modal -->
        <div class="modal fade" id="modalPegawaiTanpaJenisKelamin" tabindex="-1" aria-labelledby="modalPegawaiTanpaJenisKelaminLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalPegawaiTanpaJenisKelaminLabel">Detail Pegawai Tanpa Jenis Kelamin</h5>
                    ...
                    <div class="modal-body">
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                @foreach ($dataPegawaiTanpaJenisKelamin as $index => $pegawai)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td>{{ $pegawai->nip }}</td>
                                        <td>{{ $pegawai->nama }}</td>
    ...
    <div class="row">
        {{-- Tabel Rekapitulasi Jenis Kelamin --}}
        <div class="col-md-4">
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        const categories = {!! json_encode($rekap->pluck('jenis_kelamin')) !!};
        ...
        new ApexCharts(document.querySelector("#chartJenisKelamin"), {
            ...
            xaxis: {
                categories: ['Jenis Kelamin'] // Hanya satu kategori (untuk semua jenis kepegawaian)
            },
            yaxis: {
                title: {
                    text: 'Jumlah'
