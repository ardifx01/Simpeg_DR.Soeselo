...
<div class="container-fluid">
    <div class="pagetitle">
        <div class="row justify-content-between">
            <div class="col">
                <h1>Rekapitulasi | <small>Pegawai Bedasarkan Pendidikan</small></h1>
                <nav>
                    <ol class="breadcrumb">
    ...
    </div><!-- End Rekapitulasi Pendidikan Title -->

    {{-- Notifikasi jika ada pegawai tanpa Pendidikan --}}
    @if ($pegawaiTanpaPendidikan > 0)
        <div class="alert alert-success" role="alert">
            <i class="bi bi-info-circle"></i> 
            <strong>Perhatian.</strong> Terdapat <strong>{{ $pegawaiTanpaPendidikan }}</strong> data pegawai tidak dilengkapi dengan Pendidikan. 
            <a href="#" class="alert-link" data-bs-toggle="modal" data-bs-target="#modalPegawaiTanpaPendidikan">Lihat detail</a>
        </div>
        <!-- Modal -->
        <div class="modal fade" id="modalPegawaiTanpaPendidikan" tabindex="-1" aria-labelledby="modalPegawaiTanpaPendidikanLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalPegawaiTanpaPendidikanLabel">Detail Pegawai Tanpa Pendidikan</h5>
                    ...
                    <div class="modal-body">
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                @foreach ($dataPegawaiTanpaPendidikan as $index => $pegawai)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td>{{ $pegawai->nip }}</td>
                                        <td>{{ $pegawai->nama }}</td>
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        const categories = {!! json_encode($rekap->pluck('tingkat')) !!};
        ...
        new ApexCharts(document.querySelector("#chartPendidikan"), {
            ...
            xaxis: {
                categories: ['Pendidikan'] // Hanya satu kategori (untuk semua jenis kepegawaian)
            },
            yaxis: {
                title: {
                    text: 'Jumlah'
