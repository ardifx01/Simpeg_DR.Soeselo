...
@section('main')
        ...
        </div><!-- End Diklat Teknis Create Title -->

        <section class="section dashboard">
        <div class="row">

            <!-- Fiklat Teknis Create -->
                ...
                <form action="{{ route('diklatteknik.store') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <input name="penyelenggara" type="text" class="form-control @error('penyelenggara') is-invalid @enderror" id="penyelenggara" value="{{ old('penyelenggara') }}" required>
                                @error('penyelenggara')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <input name="jumlah_jam" type="text" class="form-control @error('jumlah_jam') is-invalid @enderror" id="jumlah_jam" value="{{ old('penyelenggara') }}" required>
                                @error('jumlah_jam')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4 col-lg-3">
                                <div class="input-group mb-3">
                                    <input name="tanggal_selesai" type="text" class="form-control @error('tanggal_selesai') is-invalid @enderror" id="tanggal_selesai" aria-label="Recipient's username" aria-describedby="button-addon2">
