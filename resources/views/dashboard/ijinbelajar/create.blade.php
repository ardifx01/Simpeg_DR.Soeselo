...
@section('main')
        ...
        <div class="pagetitle">
            <div class="row justify-content-between">
                <div class="col">
                    <h1>Ijin Belajar | <small>Tambah Ijin Belajar</small></h1>
                    <nav>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('ijinbelajar.index') }}">Riwayat Ijin Belajar</a></li>
                            <li class="breadcrumb-item active">Tambah Ijin Belajar</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4 col-lg-3">
                                <select class="form-select" aria-label="Default select example" name="jenis" id="jenis">
                                    ...
                                    <option value="Ijin Belajar" {{ old('jenis')=='Ijin Belajar' ? 'selected': '' }}>1. Ijin Belajar</option>
                                    <option value="Tugas Belajar" {{ old('jenis')=='Tugas Belajar' ? 'selected': '' }}>2. Tugas Belajar</option>
                                </select>
                            </div>
                        </div>
