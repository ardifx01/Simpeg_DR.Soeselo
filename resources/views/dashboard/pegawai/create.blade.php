            ...
            <div class="container rounded shadow p-4">
                <form action="{{ route('pegawai.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3 form-group">
                        ...
                        <div class="col-md-8 col-lg-9">
                            <input name="tingkat_pendidikan" type="text" class="form-control @error('tingkat_pendidikan') is-invalid @enderror" id="tingkat_pendidikan" value="{{ old('tingkat_pendidikan') }}">
                    ...
                    <div class="row mb-3 form-group">
                        ...
                        <div class="col-md-8 col-lg-9">
                            <input name="nama_pendidikan" type="text" class="form-control @error('nama_pendidikan') is-invalid @enderror" id="nama_pendidikan" value="{{ old('nama_pendidikan') }}">
                    ...
                    <div class="row mb-3 form-group">
                        ...
                        <div class="col-md-4 col-lg-3">
                            <div class="input-group">
                                <input name="tahun_lulus" type="text" class="form-control @error('tahun_lulus') is-invalid @enderror" id="tahun_lulus" aria-label="Recipient's username" aria-describedby="button-addon2" value="{{ old('tahun_lulus') }}">
                    ...
                    <div class="row mb-3 form-group">
                        ...
                        <div class="col-md-8 col-lg-9">
                            <input name="pangkat" type="text" class="form-control @error('pangkat') is-invalid @enderror" id="pangkat" value="{{ old('pangkat') }}">
                    ...
                    <div class="row mb-3 form-group">
                        ...
                        <div class="col-md-4 col-lg-3">
                            <select class="form-select" aria-label="Default select example" name="jenis_kepegawaian" id="jenis_kepegawaian">
                                <option selected disabled>...</option>
                    ...
                    <div class="row mb-3 form-group">
                        ...
                        <div class="col-md-4 col-lg-3">
                            <select class="form-select" aria-label="Default select example" name="status_hukum" id="status_hukum">
                                <option selected disabled>...</option>
                                <option value="Aktif" {{ old('status_hukum')=='Aktif' ? 'selected': '' }} >1. Aktif</option>
                                <option value="CLTN" {{ old('status_hukum')=='CLTN' ? 'selected': '' }} >2. CLTN</option>
                                <option value="Tugas Belajar" {{ old('status_hukum')=='Tugas Belajar' ? 'selected': '' }} >3. Tugas Belajar</option>
                                <option value="Pemberhentian sementara" {{ old('status_hukum')=='Pemberhentian sementara' ? 'selected': '' }} >4. Pemberhentian sementara</option>
                                <option value="Penerima Uang Tunggu" {{ old('status_hukum')=='Penerima Uang Tunggu' ? 'selected': '' }} >5. Penerima Uang Tunggu</option>
                                <option value="Wajib Militer" {{ old('status_hukum')=='Wajib Militer' ? 'selected': '' }} >6. Wajib Militer</option>
                                <option value="Pejabat Negara" {{ old('status_hukum')=='Pejabat Negara' ? 'selected': '' }} >7. Pejabat Negara</option>
                                <option value="Kepala Desa" {{ old('status_hukum')=='Kepala Desa' ? 'selected': '' }} >8. Kepala Desa</option>
                                <option value="Proses Banding BAPEK" {{ old('status_hukum')=='Proses Banding BAPEK' ? 'selected': '' }} >9. Proses Banding BAPEK</option>
                                <option value="Masa Persiapan Pensiun" {{ old('status_hukum')=='Masa Persiapan Pensiun' ? 'selected': '' }} >10. Masa Persiapan Pensiun</option>
                                <option value="Pensiun" {{ old('status_hukum')=='Pensiun' ? 'selected': '' }} >11. Pensiun</option>
                                <option value="Calon CPNS" {{ old('status_hukum')=='Calon CPNS' ? 'selected': '' }} >12. Calon CPNS</option>
                            </select>
                        </div>
                        @error('status_hukum')
                            <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="row mb-3 form-group">
                        ...
                        <div class="col-md-8 col-lg-9">
                            <input name="skpd" type="text" class="form-control @error('skpd') is-invalid @enderror" id="skpd" value="{{ old('skpd') }}">
                            @error('skpd')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3 form-group">
                        <label for="jenis_jabatan" class="col-md-4 col-lg-3 col-form-label">28. Jenis Jabatan</label>
                        <div class="col-md-4 col-lg-3">
                    ...
                    <div class="row mb-3 form-group">
                        ...
                        <div class="col-md-8 col-lg-9">
                            <input name="jabatan_fungsional" type="text" class="form-control @error('jabatan_fungsional') is-invalid @enderror" id="jabatan_fungsional" value="{{ old('jabatan_fungsional') }}">
                    ...
                    <div class="row mb-3 form-group">
                        ...
                        <div class="col-md-4 col-lg-3">
                            <div class="input-group">
                                <input name="tmt_jabatan" type="text" class="form-control @error('tmt_jabatan') is-invalid @enderror" id="tmt_jabatan" aria-label="Recipient's username" aria-describedby="button-addon2" value="{{ old('tmt_jabatan') }}">
                    ...
                    <div class="row mb-3 form-group">
                        ...
                        <div class="col-md-8 col-lg-9">
                            <input name="diklat_pimpinan" type="text" class="form-control @error('diklat_pimpinan') is-invalid @enderror" id="diklat_pimpinan" value="{{ old('diklat_pimpinan') }}">
                    ...
                    <div class="row mb-3 form-group">
                        ...
                        <div class="col-md-4 col-lg-3">
                            <div class="input-group">
                                <input name="tahun_diklat_pimpinan" type="text" class="form-control @error('tahun_diklat_pimpinan') is-invalid @enderror" id="tahun_diklat_pimpinan" aria-label="Recipient's username" aria-describedby="button-addon2" value="{{ old('tahun_diklat_pimpinan') }}">
